#################################################
# INITIATLIZATION
# Define fixed parameters, initiatl states, Time-maximum etc
#################################################

library(dplyr)

ag <- 3 #number of sexual activity groups
...
upNames <- c("infectiousSym1","infectiousSym2","infectiousSym3", "beta","epsilonS","epsilonC","w","aC3","T1","T2","D1","D2") #names of uncParam
Kpar <- length(upNames)   #nunmber of uncer parameters
