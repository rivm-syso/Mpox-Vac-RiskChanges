##########################################################
# 
# MODEL ODEs  -- without vaccination
#
##########################################################
...
xode <- function(time, states, parameters){
  with(as.list(c(parameters,states)),{
    ...
    list(c(dS0,dE0,dI0,dY0,dR0,dS1,dE1,dI1,dY1,dR1,dS2,dE2,dI2,dY2,dR2),c(inc=inc,sym=sym,vac1=vac1,vac2=vac2,pImm=pImm,hospi=hospi,death=death))
})}
